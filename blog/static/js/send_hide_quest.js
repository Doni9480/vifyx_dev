...
async function send_hide(e) {
    ...
    let quest = document.querySelector('input[name="quest_id"]').value;
    ...
    url = window.location.protocol + '//' + window.location.host + '/api/v1/quests/' + quest + '/hide_quest/';
    console.log(url);
...
async function send_show(e) {
    ...
    url = window.location.protocol + '//' + window.location.host + '/api/v1/quests/' + quest + '/show_quest/';
    console.log(url);
