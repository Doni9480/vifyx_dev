...
async function send_hide(e) {
    ...
    url = window.location.protocol + '//' + window.location.host + '/api/v1/surveys/' + survey + '/hide_survey/';
    console.log(url);
...
async function send_show(e) {
    ...
    url = window.location.protocol + '//' + window.location.host + '/api/v1/surveys/' + survey + '/show_survey/';
    console.log(url);
